...
- Create a vite+React application nd remove the unnecessary codes
- Run vite+React app using npm run dev command.
- Installed and configured tailwind css and daisy ui component library
